...
from .deterministic_summary import DETERMINISTIC_SUMMARY_MODEL, build_deterministic_summary
        ...
        *,
        ...
        with self._db.connection() as connection:
            ...
            if existing_summary is not None:
                ...
                # deliveries.
                replaceable_draft = existing_status == "NEEDS_REVIEW" and existing_model == DETERMINISTIC_SUMMARY_MODEL
