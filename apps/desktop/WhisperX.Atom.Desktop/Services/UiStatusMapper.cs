...
public static class UiErrorFormatter
{
    public static string Format(Exception exception, string fallback = "Не удалось выполнить операцию.") => exception switch
    {
        ...
        DesktopApiException { ErrorCode: "LOCAL_COMMAND_REQUIRED" } => "Нужна явная команда записи: «Мифодий, начни запись» или «Мифодий, останови запись».",
        DesktopApiException { ErrorCode: "VOICE_COMMAND_REPEAT_REQUIRED" } => "Повторите голосовую команду. Состояние записи не изменено.",
