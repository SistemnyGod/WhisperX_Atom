...
public sealed class BackendService : IBackendService
{
    ...
    public Task<DesktopAssistantMessageCreateResult?> CreateAssistantMessageAsync(Guid conversationId, string content, Guid? retryOf = null, string? requestedMode = null, Guid? activeMeetingId = null, string? timeZone = null, string? previousResolvedMode = null, CancellationToken cancellationToken = default) => _client.CreateAssistantMessageAsync(conversationId, content, retryOf, requestedMode, activeMeetingId, timeZone, previousResolvedMode, cancellationToken);
    ...
    public Task<DesktopAssistantRequestAccepted?> GetAssistantRequestByCommandAsync(string commandId, CancellationToken cancellationToken = default) => _client.GetAssistantRequestByCommandAsync(commandId, cancellationToken);
    ...
    public Task<DesktopMemoryCoverage?> GetMemoryCoverageAsync(CancellationToken cancellationToken = default) => _client.GetMemoryCoverageAsync(cancellationToken);
    public Task<DesktopMemoryRebuildResult?> RebuildMemoryAsync(string mode, CancellationToken cancellationToken = default) => _client.RebuildMemoryAsync(mode, cancellationToken);
