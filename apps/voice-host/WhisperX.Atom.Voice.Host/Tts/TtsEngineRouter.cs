...
public sealed class TtsEngineRouter : IAsyncDisposable
{
    ...
    public string VoiceName => _useFallback ? _windows.VoiceName : TtsVoiceProfiles.IsTechnologyProfile(_voiceProfile) ? "eugene" : TtsVoiceProfiles.IsAidarClean(_voiceProfile) ? "aidar" : _silero.VoiceName;
    ...
    public bool FxEnabled => TtsVoiceProfiles.IsTechnologyProfile(_voiceProfile) && !_useFallback;
    ...
    public IReadOnlyList<object> GetTtsVoices() =>
        new object[] { new { id = "aidar", displayName = "Айдар", engine = "SILERO", culture = "ru-RU", available = _silero.IsReady }, new { id = "eugene", displayName = "Евгений", engine = "SILERO", culture = "ru-RU", available = _silero.IsReady }, new { id = "baya", displayName = "Байя", engine = "SILERO", culture = "ru-RU", available = _silero.IsReady }, new { id = "kseniya", displayName = "Ксения", engine = "SILERO", culture = "ru-RU", available = _silero.IsReady }, new { id = "xenia", displayName = "Ксения (Xenia)", engine = "SILERO", culture = "ru-RU", available = _silero.IsReady } }
