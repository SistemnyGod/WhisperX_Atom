...
public sealed class MifodiyVoiceFxSampleProvider : ISampleProvider
{
    ...
    // The optional profile argument remains for IPC/source compatibility;
    // all supported profiles use the same bounded Russian playback chain.
    public MifodiyVoiceFxSampleProvider(ISampleProvider source, string? voiceProfile = null)
    {
