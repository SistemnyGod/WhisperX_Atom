...
foreach ($script in @('start-server-bundle.ps1','stop-server-bundle.ps1','doctor-server-bundle.ps1','install-server-startup-task.ps1','prune-stale-worker-heartbeats.ps1','backup.ps1','restore.ps1','e2e-backup-restore.ps1')) {
